...
main()
{
	...
	// 1. hello
	// 2. world
	copy(hello.begin(), hello.end(), ostream_joiner(cout, ostream_counter{}, prefix));
    cout << endl;
    ...
    // Prints | | 
    copy(empty.begin(), empty.end(), ostream_joiner(cout, " | ", " | ", " | ")); // prints | |
    cout << endl;

	// Prints nothing
    copy(empty.begin(), empty.end(), ostream_joiner(cout, " | ", prefix | suffix)); // prints nothing
    cout << endl;
